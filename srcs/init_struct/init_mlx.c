...
void	init_image(t_cub3d *data)
{
	...
	data->framebuffer.addr = mlx_get_data_addr(data->framebuffer.img_ptr, &data->framebuffer.bpp, &data->framebuffer.line_len, &data->framebuffer.endian);
	...
	*/
	//data->framebuffer.bpp /= 8; //remettre
}
